/* eslint-disable */
/* 来源于 https://github.com/aralejs/qrcode */
...
qrcode.prototype.createDefault = function createDefault(qrCodeAlg) {
...
// canvas create
qrcode.prototype.createCanvas = function createCanvas(qrCodeAlg) {
...
// table create
qrcode.prototype.createTable = function createTable(qrCodeAlg) {
    var options = this.options;
    var count = qrCodeAlg.getModuleCount();
...
// create svg
qrcode.prototype.createSVG = function createSVG(qrCodeAlg) {
    var options = this.options;
    var count = qrCodeAlg.getModuleCount();
